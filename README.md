...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/qcs-api-client-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14378&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/qcs-api-client-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `qcs-api-client` can be installed with:

```
conda install qcs-api-client
```

It is possible to list all of the versions of `qcs-api-client` available on your platform with:
